                ...
                <div class="bg-white rounded-xl shadow-xl overflow-hidden">
                    ...
                    <div class="p-6 font-mono">
                        ...
                        <div class="text-indigo-600">});</div>
                                                <div class="mt-4 text-gray-500">// For a resource like posts...</div>
                        <div class="text-indigo-600">Route::get('/posts', [PostController::class, 'index']);</div>
                        <div class="text-indigo-600">Route::get('/posts/{id}', [PostController::class, 'show']);</div>
                        <div class="text-indigo-600">Route::post('/posts', [PostController::class, 'store']);</div>
                    </div>
                </div>
            </div>
        </div>
