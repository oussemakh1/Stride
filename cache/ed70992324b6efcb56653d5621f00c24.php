...
<head>
    ...
    <link href="<?php echo htmlspecialchars($this->customFunctions['asset']('css/style.css')); ?>" rel="stylesheet">
...
<body>
    ...
    <script src="<?php echo htmlspecialchars($this->customFunctions['asset']('js/app.js')); ?>"></script>
    <script>
